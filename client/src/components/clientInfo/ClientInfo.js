              ...
              <Row className="mb-3 mt-3">
                ...
                <Form.Group as={Col} controlId="formGridState">
                  ...
                  <Form.Select defaultValue="Choose..." >
                    ...
                    <option className="p-3 mb-2 bg-secondary text-white" 
                            key={country._id}>{country}</option>))}
                    </Form.Select>
                </Form.Group>
                </Row>
                ...
                <Row className="mb-3">
                    <Form.Group as={Col} controlId="formGridPasportNumber">
                        ...
                        <Form.Control type="text" placeholder="Введите серию и номер паспорта" />
                    </Form.Group>
              ...
              <Row className="mb-3">
                ...
                <Row className="mb-3 mt-3">
                    ...
                    <Form.Group as={Col} controlId="formGridPassword">
                        ...
                        <Form.Control type="text" placeholder="Ведите область и район" />
                    </Form.Group>
                </Row>
